...
namespace SavingTraker.App.Interfaces
{
    public interface IContributionService
    {
       ...
       Task<int> UpSert(ContributionModel dto, CancellationToken cancellationToken);
       Task<int> Delete(int Id, CancellationToken cancellationToken);
       Task<List<int>> BulkUpsert(List<ContributionModel> dto, CancellationToken cancellationToken);
    }
}
